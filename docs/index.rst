...
Observatories Watching Transients Happen (GROWTH) collaboration in order to
coordinate follow-up observations of multimessenger transients. The ToO
Marshal's responsibilities include:
...
.. note::
   *Caveat emptor*: This repository has been made publicly available in the
   spirit of open-source software. However, much of the code is very specific
   to the particular facilities, instruments, and data sources that we are
   using, and may not be immediately generalizable.
